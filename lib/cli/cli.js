...
async function _create({ fileMode = false, __fileDirname = '', awsProfile, sshPublicKey: _sshPublicKey, orbsAddress, orbsPrivateKey, region,
    nodeSize, publicIp, noEthereum = false, nodeCount, cachePath: _catchPath, name, bootstrapUrl, configPath: _configPath, chainVersion, _file, ethereumChain, ethereumTopologyContractAddress, incomingSshCidrBlocks }) {
    let errorMessage;
