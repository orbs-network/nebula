...
function createBoyarConfig({ configPath, chainVersion }) {
    const nodeKeys = require(`${__dirname}/../${configPath}/keys.json`);
    const ips = require(`${__dirname}/../${configPath}/ips.json`);
    const boyarConfig = require(`${__dirname}/../${configPath}/boyar.json`);
