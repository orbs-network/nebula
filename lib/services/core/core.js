...
class CoreService {
    ...
    async createConstellation({ cloud = {}, keys = {}, }) {
        ...
        // We poll the master to see that the cluster is awake and ready to accept commands
        //await this.eventuallyReady(swarmMasterPublicIp);

        // Setup Ethereum Node on the cluster
        //await this.setupEthereumNode({ ip: swarmMasterPublicIp, keys });
