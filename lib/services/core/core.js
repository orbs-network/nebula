...
class CoreService {
    ...
    async createConstellation({ cloud = {}, keys = {}, }) {
        ...
        // We poll the manager to see that the cluster is awake and ready to accept commands
        //await this.eventuallyReady(swarmmanagerPublicIp);

        // Setup Ethereum Node on the cluster
        //await this.setupEthereumNode({ ip: swarmmanagerPublicIp, keys });
