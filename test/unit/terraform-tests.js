...
describe('terraform service unit tests', () => {
    ...
    describe("createTerraformVariablesFile", () => {
        it("default call", () => {
            ...
            const chains = keys.orbs.boyarConfig.chains;
...
instance_count = 0
chains = [{"id":10000,"gossip_port":4400,"http_port":8080,"docker":{"image":"orbsnetwork/node","tag":"v0.9.3"}},{"id":20000,"gossip_port":4401,"http_port":8081,"docker":{"image":"orbsnetwork/node","tag":"v0.9.3"}},{"id":30000,"gossip_port":4402,"http_port":8082,"docker":{"image":"orbsnetwork/node","tag":"v0.9.3"}}]
